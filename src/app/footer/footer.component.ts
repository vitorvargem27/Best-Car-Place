...
export class FooterComponent {
  ...
  title: string = 'Best Car Place';
    copyright: string = 'Desenvolvido em 08/2023';
    developer: string = 'Vitor Vargem - Start Tech TOTVS';
    ...
    redesSociais: Array<any> = [
      ...
      },
      {
        ...
        icone: 'https://i.ibb.co/Z8ztwDt/twitter.png',
      }
    ]
